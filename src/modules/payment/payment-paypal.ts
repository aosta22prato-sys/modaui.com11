...
export class PayPalService {
  ...
  async createPayment(orderId: string, amount: number, description: string): Promise<any> {
    const paymentDetails = {
      ...
      redirect_urls: {
        return_url: `${process.env.API_BASE_URL || 'https://modaui.com'}/api/payments/paypal/success`,
        cancel_url: `${process.env.API_BASE_URL || 'https://modaui.com'}/api/payments/paypal/cancel`
      }
    };
